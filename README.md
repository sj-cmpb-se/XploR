...
| `sampletype`         | character | Sample type for QC thresholds: `"ff"` (Fresh Frozen) or `"ffpe"` (Formalin-Fixed Paraffin-Embedded). `"ff"` uses stricter cutoffs and is the default. | `"ff"`            |
